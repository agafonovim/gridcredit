<?php $boardpage = 'yes'; ?>
<?php include_once $_SERVER['DOCUMENT_ROOT'] . '/core/categoryscript.php'; ?>
<!doctype html>
<html>

  <head>
    <meta property="og:title" content="Выборка из категории '<?php echo $categoryname['name']; ?>' — Кредитные объявления на портале ГридКредит">
    <meta property="og:description" content="Все кредитные объявления из категории '<?php echo $categoryname['name']; ?>', самые популярные категории: помощь в получении кредита, кредит с плохой кредитной историей, частный и быстрый заём.">
    ...
    <meta property="og:url" content="https://gridcredit.ru/board/category/<?php echo htmlspecialchars($categorynumber, ENT_QUOTES, 'UTF-8'); ?>/page/<?php echo htmlspecialchars($defaultpagenumber, ENT_QUOTES, 'UTF-8'); ?>">
    <title>Выборка из категории '<?php echo $categoryname['name']; ?>' — Кредитные объявления на портале ГридКредит</title>
    <meta name="description" content="Все кредитные объявления из категории '<?php echo $categoryname['name']; ?>', самые популярные категории: помощь в получении кредита, кредит с плохой кредитной историей, частный и быстрый заём.">
       ...
       <?php include_once $_SERVER['DOCUMENT_ROOT'] . '/core/tmp/premium.php'; ?>
        <div class="collection">
          <div class="collection-header">
            <h1 class="collection-title">Выборка из категории '<?php echo $categoryname['name']; ?>'</h1>
        ...
        <div class="collection">
          <div class="pagination">
            ...
            <a href="/board/category/<?php echo $categorynumber; ?>/page/<?php echo $defaultnext ?>" class="next">Старее &gt;</a>
          </div>
        </div>
        <?php elseif ($defaultpagenumber >= $defaultpages): ?>
        <div class="collection">
          <div class="pagination">
            <a href="/board/category/<?php echo $categorynumber; ?>/page/<?php echo $defaultprev ?>" class="previous">&lt; Новее</a>
